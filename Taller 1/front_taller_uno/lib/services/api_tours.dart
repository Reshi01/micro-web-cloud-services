...
class Api_tours{
  ...
  Future<List<Paseo>> getPaseos() async {
    ...
    if (response.statusCode == 200) {
      ...
      print("Solicitud GET realizada correctamente");
  ...
  void modifyPath( String start, String finish, String id) async {
    ...
    final response = await http
        ...
        '&startLocation=' + start + '&endLocation=' + finish)
  ...
  Future<bool> postPaseo(String name, String dateTime, String start, String finish) async {
    ...
    print("Solicitud POST realizada correctamente");
    return true;
  }

  void deletePaseo(String id) async {
    final response =
        await http.delete(Uri.parse('http://10.0.2.2:8080/myapp/paseos/delete?id=' + id));
